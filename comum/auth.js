...
const auth = (server, comum, usuario, validationContract, errs) => {
    ...
    server.post('/autenticacao', (req, res, next) => {
        ...
        contract.isRequired(req.params.idcliente, 'A requisição deve conter o parâmetro idcliente.');
